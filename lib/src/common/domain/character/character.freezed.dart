...
mixin _$Character {
  ...
  IList<Episode> get episode => throw _privateConstructorUsedError;
...
class _$_Character implements _Character {
  ...
  final String image;
  @override
  final IList<Episode> episode;

  @override
  String toString() {
    return 'Character(id: $id, name: $name, gender: $gender, status: $status, image: $image, episode: $episode)';
  }
...
abstract class _Character implements Character {
  const factory _Character(
      ...
      required Status status,
      required String image,
      required IList<Episode> episode}) = _$_Character;
